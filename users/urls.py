...
from users.views import UserUpdateView, RegisterView, EmailVerify, LoginView, LogoutView, forgot_password, UserDetailView, moderator_personal_area, user_change_active
...
urlpatterns = [
    ...
    path('moderator', moderator_personal_area, name='moderator_personal_area'),
